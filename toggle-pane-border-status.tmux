...
# receive plugin configuration
toggle_pane_border_status_automation_enabled="@toggle_pane_border_status_key_automation"
...
tmux_add_toggle_pane_border_status_hooks() {
    local -r position=$(tmux_option "toggle_pane_border_status_position" "top")
...
is_key_enabled=$(tmux_option "@toggle_pane_border_status_key_enabled" "1")
